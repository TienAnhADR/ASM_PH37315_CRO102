                ...
                <View>
                    <View style={styles.from}>
                        ...
                        <TouchableOpacity style={styles.button} onPress={doLogin}>
                            <Text style={{ color: '#000', fontSize: 14, fontWeight: 'bold' }} >Register</Text>
                        </TouchableOpacity>

                        
                        <Text onPress={() => { navigation.navigate('LoginComd') }} style={{ color: 'gray', margin: 20 }}> Click <Text style={{ color: '#D17842' }}>Login</Text></Text>
